...
/* 
 * jsTree jstree plugin
 * Handles loading and setting jstree, as well as detecting path to jstree, etc.
 */
(function ($) {
	var themes_loaded = [];
	// this variable stores the path to the jstree folder - if left as false - it will be autodetected
	...
	$(function () {
		...
		if($.jstree._themes === false) { $.jstree._themes = "assets/jstree/themes/"; }
	});
	// include the jstree plugin by default
 ...
 * Adds support for jQuery UI jstree. Include this at the end of your plugins list, also make sure "jstree" is not included.
 */
(function ($) {
